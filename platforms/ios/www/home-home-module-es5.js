    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(service) {
        ...
        this.results.subscribe(function (resp) {
          ...
          _this.worldArray = resp;
        });
        this.results = this.service.getData('qatar');
        this.results.subscribe(function (resp) {
          console.log('COVID19 Data: ', resp);
          _this.qatarArray = resp;
        });
        this.results = this.service.getData('nigeria');
        this.results.subscribe(function (resp) {
          console.log('COVID19 Data: ', resp);
          _this.nigeriaArray = resp;
          _this.endlessCoronaArray = _this.nigeriaArray;
        });
        this.results = this.service.getData('lebanon');
        this.results.subscribe(function (resp) {
          console.log('COVID19 Data: ', resp);
          _this.qlebArray = resp;
        });
      }
